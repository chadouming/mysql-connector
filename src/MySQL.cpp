...
#define CONNECTED 				"Connected to server version "
#define DISCONNECTED 			"Disconnected."
#define MEMORY_ERROR			"Memory error."
#define PACKET_ERROR			"Packet error."
#define BAD_MOJO 				"Bad mojo. EOF found reading column header."
#define ROWS					" rows in result."
#define READ_COLS				"ERROR: You must read the columns first!"
